 ...
 * hierarchy for nodes that match {@link android.support.test.wqhyy.BySelector} criteria.
 */
class ByMatcher {
    ...
    private android.support.test.wqhyy.BySelector mSelector;
    private boolean mShortCircuit;

    /**
     * Constructs a new {@link ByMatcher} instance. Used by
     * {@link ByMatcher#findMatch(UiDevice, android.support.test.wqhyy.BySelector, AccessibilityNodeInfo...)} to store state information
     ...
     */
    private ByMatcher(UiDevice device, android.support.test.wqhyy.BySelector selector, boolean shortCircuit) {
        mDevice = device;
        mSelector = selector;
     ...
     * @param selector The {@link android.support.test.wqhyy.BySelector} criteria used to determine if a node is a match.
     * @return The first {@link AccessibilityNodeInfo} which matched the search criteria.
     */
    static AccessibilityNodeInfo findMatch(UiDevice device, android.support.test.wqhyy.BySelector selector,
     ...
     */
    static List<AccessibilityNodeInfo> findMatches(UiDevice device, android.support.test.wqhyy.BySelector selector,
            AccessibilityNodeInfo... roots) {
     ...
     * {@link android.support.test.wqhyy.BySelector}. Attributes of the current node itself have been evaluated, but any child
    ...
    static private class PartialMatch {
        ...
        private final android.support.test.wqhyy.BySelector matchSelector;
         ...
         * {@link PartialMatch#accept(AccessibilityNodeInfo, android.support.test.wqhyy.BySelector, int, int)} factory method.
         */
        private PartialMatch(android.support.test.wqhyy.BySelector selector, int depth) {
         ...
         */
        public static PartialMatch accept(AccessibilityNodeInfo node, android.support.test.wqhyy.BySelector selector,
                int index, int depth) {
        ...
        public SinglyLinkedList<PartialMatch> update(AccessibilityNodeInfo node,
            ...
            for (android.support.test.wqhyy.BySelector childSelector : matchSelector.mChildSelectors) {
        ...
        public boolean finalizeMatch() {
            ...
            Set<android.support.test.wqhyy.BySelector> matches = new HashSet<android.support.test.wqhyy.BySelector>();
