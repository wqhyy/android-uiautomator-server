...
public final class Configurator {
     ...
     *
     * By default, all core uiautomator objects except {@link android.support.test.wqhyy.UiDevice} will perform
     * this wait before starting to search for the widget specified by the
     * object's {@link android.support.test.wqhyy.UiSelector}. Once the idle state is detected or the
     ...
     * See {@link android.support.test.wqhyy.UiScrollable}
     *
     * @param timeout Timeout value in milliseconds
     * @return self
     * @since API Level 18
     ...
     * See {@link android.support.test.wqhyy.UiObject}
     *
     * @param timeout Timeout value in milliseconds
     * @return self
     * @since API Level 18
     ...
     * See {@link android.support.test.wqhyy.UiObject#setText(String)}
     *
