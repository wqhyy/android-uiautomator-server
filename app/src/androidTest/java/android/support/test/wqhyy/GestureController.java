...
class GestureController {
     ...
     *
     * @param condition The {@link android.support.test.wqhyy.EventCondition} to wait for.
     ...
     */
    public <R> R performGestureAndWait(android.support.test.wqhyy.EventCondition<R> condition, long timeout,
