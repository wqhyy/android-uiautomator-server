...
/**
 * The QueryController main purpose is to translate a {@link android.support.test.wqhyy.UiSelector} selectors to
...
class QueryController {
     ...
     */
    public int getPatternCount(android.support.test.wqhyy.UiSelector selector) {
     ...
     */
    public AccessibilityNodeInfo findAccessibilityNodeInfo(android.support.test.wqhyy.UiSelector selector) {
        return findAccessibilityNodeInfo(selector, false);
    }

    protected AccessibilityNodeInfo findAccessibilityNodeInfo(android.support.test.wqhyy.UiSelector selector,
                                                              boolean isCounting) {
        mUiAutomatorBridge.waitForIdle();
        initializeNewSearch();
        ...
        android.support.test.wqhyy.UiSelector uiSelector = new android.support.test.wqhyy.UiSelector(selector);
     ...
     * @return AccessibilityNodeInfo
     */
    private AccessibilityNodeInfo translateCompoundSelector(android.support.test.wqhyy.UiSelector selector,
    ...
    /**
     * Used by the {@link #translateCompoundSelector(android.support.test.wqhyy.UiSelector, AccessibilityNodeInfo, boolean)}
     ...
     */
    private AccessibilityNodeInfo translateReqularSelector(android.support.test.wqhyy.UiSelector selector,
                                                           AccessibilityNodeInfo fromNode) {

        return findNodeRegularRecursive(selector, fromNode, 0);
    }

    private AccessibilityNodeInfo findNodeRegularRecursive(android.support.test.wqhyy.UiSelector subSelector,
     ...
     * See {@link #translateCompoundSelector(android.support.test.wqhyy.UiSelector, AccessibilityNodeInfo, boolean)}
     */
    private AccessibilityNodeInfo translatePatternSelector(android.support.test.wqhyy.UiSelector subSelector,
                                                           AccessibilityNodeInfo fromNode, boolean isCounting) {
    ...
    private AccessibilityNodeInfo findNodePatternRecursive(
            android.support.test.wqhyy.UiSelector subSelector, AccessibilityNodeInfo fromNode, int index,
            android.support.test.wqhyy.UiSelector originalPattern) {
