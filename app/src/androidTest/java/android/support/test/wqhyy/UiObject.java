 ...
 * locate a matching view at runtime based on the {@link android.support.test.wqhyy.UiSelector} properties specified in
...
public class UiObject {
    ...
    private final android.support.test.wqhyy.UiSelector mUiSelector;
     ...
     * selector criteria.
     *
     * @deprecated Use {@link UiDevice#findObject(android.support.test.wqhyy.UiSelector)} instead. This version hides
     * UiObject's dependency on UiDevice and is prone to misuse.
     * @param selector
     * @since API Level 16
     */
    @Deprecated
    public UiObject(android.support.test.wqhyy.UiSelector selector) {
        mUiSelector = selector;
        mDevice = UiDevice.getInstance();
    }

    /**
     * Package-private constructor. Used by {@link UiDevice#findObject(android.support.test.wqhyy.UiSelector)} to construct a
     * UiObject.
     */
    UiObject(UiDevice device, android.support.test.wqhyy.UiSelector selector) {
        mDevice = device;
        mUiSelector = selector;
    }
     ...
     *
     * @return {@link android.support.test.wqhyy.UiSelector}
     * @since API Level 16
     */
    public final android.support.test.wqhyy.UiSelector getSelector() {
    ...
    /**
     * Retrieves the {@link android.support.test.wqhyy.QueryController} to translate a {@link android.support.test.wqhyy.UiSelector} selector
     * into an {@link AccessibilityNodeInfo}.
     *
     * @return {@link android.support.test.wqhyy.QueryController}
     */
    android.support.test.wqhyy.QueryController getQueryController() {
        return mDevice.getAutomatorBridge().getQueryController();
    }

    /**
     * Retrieves the {@link android.support.test.wqhyy.InteractionController} to perform finger actions such as tapping,
     * swiping, or entering text.
     *
     * @return {@link android.support.test.wqhyy.InteractionController}
     */
    android.support.test.wqhyy.InteractionController getInteractionController() {
     ...
     * @since API Level 16
     */
    public UiObject getChild(android.support.test.wqhyy.UiSelector selector) throws UiObjectNotFoundException {
     ...
     * @since API Level 16
     */
    public UiObject getFromParent(android.support.test.wqhyy.UiSelector selector) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(selector);
    ...
    private Rect getVisibleBounds(AccessibilityNodeInfo node) {
        ...
        Rect nodeRect = android.support.test.wqhyy.AccessibilityNodeInfoHelper.getVisibleBoundsInScreen(node, w, h);
        ...
        Rect parentRect = android.support.test.wqhyy.AccessibilityNodeInfoHelper
    ...
    public void legacySetText(String text) throws UiObjectNotFoundException {
        ...
        UiObject selectAll = new UiObject(new android.support.test.wqhyy.UiSelector().descriptionContains("Select all"));
     ...
     *
     * <p>
     * The {@link android.support.test.wqhyy.UiSelector} selector of this object must reference a UI element that is editable.
     *
     * <p>
     ...
     *
     * The {@link android.support.test.wqhyy.UiSelector} of this object must reference a UI element that is editable.
     *
     ...
     * timeout has elapsed.
     *
     * A view becomes undetectable when the {@link android.support.test.wqhyy.UiSelector} of the object is
