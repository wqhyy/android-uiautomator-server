 ...
 * may be necessary to call {@link UiDevice#findObject(android.support.test.wqhyy.BySelector)} to obtain a new
...
public class UiObject2 implements Searchable {
    ...
    private android.support.test.wqhyy.BySelector mSelector;  // Hold this mainly for debugging
    ...
    /** Package-private constructor. Used by {@link UiDevice#findObject(android.support.test.wqhyy.BySelector)}. */
    UiObject2(UiDevice device, android.support.test.wqhyy.BySelector selector, AccessibilityNodeInfo cachedNode) {
        mDevice = device;
        mSelector = selector;
    ...
    public boolean equals(Object object) {
        ...
        } catch (android.support.test.wqhyy.StaleObjectException e) {
            return false;
        }
    }
     ...
     */
    public UiObject2 findObject(android.support.test.wqhyy.BySelector selector) {
        AccessibilityNodeInfo node =
                ByMatcher.findMatch(mDevice, selector, getAccessibilityNodeInfo());
    ...
    public List<UiObject2> findObjects(android.support.test.wqhyy.BySelector selector) {
    ...
    public <R> R clickAndWait(android.support.test.wqhyy.EventCondition<R> condition, long timeout) {
     ...
     */
    public void swipe(android.support.test.wqhyy.Direction direction, float percent) {
     ...
     * @param speed The speed at which to perform this gesture in pixels per second.
     */
    public void swipe(android.support.test.wqhyy.Direction direction, float percent, int speed) {
        if (percent < 0.0f || percent > 1.0f) {
            throw new IllegalArgumentException("Percent must be between 0.0f and 1.0f");
        }
        if (speed < 0) {
     ...
     */
    public boolean scroll(final android.support.test.wqhyy.Direction direction, final float percent) {
     ...
     * @return Whether the object can still scroll in the given direction.
     */
    public boolean scroll(android.support.test.wqhyy.Direction direction, float percent, final int speed) {
        if (percent < 0.0f) {
        ...
        final android.support.test.wqhyy.Direction swipeDirection = android.support.test.wqhyy.Direction.reverse(direction);
        ...
        for (; percent > 0.0f; percent -= 1.0f) {
            ...
            if (mGestureController.performGestureAndWait(
                    android.support.test.wqhyy.Until.scrollFinished(direction), SCROLL_TIMEOUT, swipe)) {
                return false;
            }
        }
     ...
     * @return Whether the object can still scroll in the given direction.
     */
    public boolean fling(final android.support.test.wqhyy.Direction direction) {
     ...
     * @return Whether the object can still scroll in the given direction.
     */
    public boolean fling(final android.support.test.wqhyy.Direction direction, final int speed) {
        ...
        return !mGestureController.performGestureAndWait(
                android.support.test.wqhyy.Until.scrollFinished(direction), FLING_TIMEOUT, swipe);
    }
    ...
    public void legacySetText(String text) {
        ...
        if (!text.equals(currentText)) {
            android.support.test.wqhyy.InteractionController ic = mDevice.getAutomatorBridge().getInteractionController();
            ...
            mDevice.wait(android.support.test.wqhyy.Until.findObject(By.descContains("Select all")), 50).click();
    ...
    private AccessibilityNodeInfo getAccessibilityNodeInfo() {
        ...
        if (!mCachedNode.refresh()) {
            ...
            if (!mCachedNode.refresh()) {
                throw new android.support.test.wqhyy.StaleObjectException();
            }
        }
        return mCachedNode;
    }
