...
/**
 * UiScrollable is a {@link android.support.test.wqhyy.UiCollection} and provides support for searching
 * for items in scrollable layout elements. This class can be used with
 * horizontally or vertically scrollable controls.
 * @since API Level 16
 */
public class UiScrollable extends android.support.test.wqhyy.UiCollection {
     ...
     * Constructor.
     *
     * @param container a {@link android.support.test.wqhyy.UiSelector} selector to identify the scrollable
     *     layout element.
     * @since API Level 16
     */
    public UiScrollable(android.support.test.wqhyy.UiSelector container) {
     ...
     * @since API Level 16
     */
    protected boolean exists(android.support.test.wqhyy.UiSelector selector) {
     ...
     * scroll search.
     * See {@link #getChildByDescription(android.support.test.wqhyy.UiSelector, String, boolean)}
     *
     * @param childPattern {@link android.support.test.wqhyy.UiSelector} for a child in a scollable layout element
     * @param text Content-description to find in the children of 
     * the <code>childPattern</code> match
     * @return {@link android.support.test.wqhyy.UiObject} representing the child element that matches the search conditions
     * @throws UiObjectNotFoundException
     * @since API Level 16
     */
    @Override
    public android.support.test.wqhyy.UiObject getChildByDescription(android.support.test.wqhyy.UiSelector childPattern, String text)
            throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(childPattern, text);
    ...
    public android.support.test.wqhyy.UiObject getChildByDescription(android.support.test.wqhyy.UiSelector childPattern, String text,
        ...
        android.support.test.wqhyy.Tracer.trace(childPattern, text, allowScrollSearch);
        if (text != null) {
            if (allowScrollSearch) {
                scrollIntoView(new android.support.test.wqhyy.UiSelector().descriptionContains(text));
            }
     ...
     */
    @Override
    public android.support.test.wqhyy.UiObject getChildByInstance(android.support.test.wqhyy.UiSelector childPattern, int instance)
            throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(childPattern, instance);
        ...
        return new android.support.test.wqhyy.UiObject(patternSelector);
    }
     ...
     * scroll search.
     * See {@link #getChildByText(android.support.test.wqhyy.UiSelector, String, boolean)}
     *
     * @param childPattern {@link android.support.test.wqhyy.UiSelector} selector for a child in a scrollable layout element
     ...
     */
    @Override
    public android.support.test.wqhyy.UiObject getChildByText(android.support.test.wqhyy.UiSelector childPattern, String text)
            throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(childPattern, text);
     ...
     * @since API Level 16
     */
    public android.support.test.wqhyy.UiObject getChildByText(android.support.test.wqhyy.UiSelector childPattern, String text, boolean allowScrollSearch)
            throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(childPattern, text, allowScrollSearch);
        if (text != null) {
            if (allowScrollSearch) {
                scrollIntoView(new android.support.test.wqhyy.UiSelector().text(text));
            }
    ...
    public boolean scrollDescriptionIntoView(String text) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(text);
        return scrollIntoView(new android.support.test.wqhyy.UiSelector().description(text));
    }

    /**
     * Perform a forward scroll action to move through the scrollable layout element until
     * a visible item that matches the {@link android.support.test.wqhyy.UiObject} is found.
     *
     * @param obj {@link android.support.test.wqhyy.UiObject}
     * @return true if the item was found and now is in view else false
     * @since API Level 16
     */
    public boolean scrollIntoView(android.support.test.wqhyy.UiObject obj) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(obj.getSelector());
     ...
     *
     * @param selector {@link android.support.test.wqhyy.UiSelector} selector
     * @return true if the item was found and now is in view; else, false
     * @since API Level 16
     */
    public boolean scrollIntoView(android.support.test.wqhyy.UiSelector selector) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(selector);
        // if we happen to be on top of the text we want then return here
        android.support.test.wqhyy.UiSelector childSelector = getSelector().childSelector(selector);
     ...
     *
     * @param childObject {@link android.support.test.wqhyy.UiObject} representing the child element
     ...
     * @hide
     */
    public boolean ensureFullyVisible(android.support.test.wqhyy.UiObject childObject) throws UiObjectNotFoundException {
    ...
    public boolean scrollTextIntoView(String text) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(text);
        return scrollIntoView(new android.support.test.wqhyy.UiSelector().text(text));
    }

    /**
     * Sets the maximum number of scrolls allowed when performing a
     * scroll action in search of a child element.
     * See {@link #getChildByDescription(android.support.test.wqhyy.UiSelector, String)} and
     * {@link #getChildByText(android.support.test.wqhyy.UiSelector, String)}.
     *
    ...
    public UiScrollable setMaxSearchSwipes(int swipes) {
        android.support.test.wqhyy.Tracer.trace(swipes);
    ...
    public boolean scrollForward(int steps) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(steps);
    ...
    public boolean scrollToBeginning(int maxSwipes, int steps) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(maxSwipes, steps);
    ...
    public boolean scrollToBeginning(int maxSwipes) throws UiObjectNotFoundException {
        android.support.test.wqhyy.Tracer.trace(maxSwipes);
    ...
    public UiScrollable setSwipeDeadZonePercentage(double swipeDeadZonePercentage) {
        android.support.test.wqhyy.Tracer.trace(swipeDeadZonePercentage);
