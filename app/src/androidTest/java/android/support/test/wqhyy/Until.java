...
public class Until {
    ...
    /**
     * Returns a {@link android.support.test.wqhyy.SearchCondition} that is satisfied when no elements matching the selector
     * can be found.
     */
    public static android.support.test.wqhyy.SearchCondition<Boolean> gone(final BySelector selector) {
        return new android.support.test.wqhyy.SearchCondition<Boolean>() {
            @Override
    ...
    /**
     * Returns a {@link android.support.test.wqhyy.SearchCondition} that is satisfied when at least one element matching the
     * selector can be found.
     */
    public static android.support.test.wqhyy.SearchCondition<Boolean> hasObject(final BySelector selector) {
        return new android.support.test.wqhyy.SearchCondition<Boolean>() {
            @Override
            Boolean apply(Searchable container) {
                return container.hasObject(selector);
     ...
     */
    public static android.support.test.wqhyy.SearchCondition<UiObject2> findObject(final BySelector selector) {
        return new android.support.test.wqhyy.SearchCondition<UiObject2>() {
            @Override
     ...
     */
    public static android.support.test.wqhyy.SearchCondition<List<UiObject2>> findObjects(final BySelector selector) {
        return new android.support.test.wqhyy.SearchCondition<List<UiObject2>>() {
            @Override
     ...
     */
    public static EventCondition<Boolean> scrollFinished(final android.support.test.wqhyy.Direction direction) {
        return new EventCondition<Boolean>() {
            private android.support.test.wqhyy.Direction mDirection = direction;
