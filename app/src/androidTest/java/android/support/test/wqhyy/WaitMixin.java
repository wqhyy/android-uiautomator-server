...
class WaitMixin<T> {
    ...
    public <R> R wait(android.support.test.wqhyy.Condition<? super T, R> condition, long timeout) {
        return wait(condition, timeout, DEFAULT_POLL_INTERVAL);
    }

    public <R> R wait(android.support.test.wqhyy.Condition<? super T, R> condition, long timeout, long interval) {
